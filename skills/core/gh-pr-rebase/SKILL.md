---
name: gh-pr-rebase
description: Check a GitHub pull request for conflicts with local gh and delegate confirmed conflicts to git-rebase-conflict-resolver using the PR target branch.
---
...
Return normalized PR JSON and, when rebased, the resolver report. Create no artifact.
